...
| 預覽版  | [![Preview v0.5.8-beta.1](https://img.shields.io/badge/Preview-v0.5.8--beta.1-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.5.8-beta.1) | 目前預覽版：`v0.5.8-beta.1`。也可在應用內「設定 → 關於」打開「預覽版通道」後自動檢查並升級 |
...
- 圖片 Prompt 反推、AI 模型服務配置與專案 Skill 緊湊列表進入預覽驗證
- CLI `--version` 與 npm package 版本同步到 `0.5.8-beta.1`
