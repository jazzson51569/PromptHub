...
| プレビュー       | [![Preview v0.5.8-beta.1](https://img.shields.io/badge/Preview-v0.5.8--beta.1-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.5.8-beta.1) | 現在のプレビュー版は `v0.5.8-beta.1` です。必要なら「設定 → このアプリについて」でプレビューチャンネルを有効化して自動チェックと更新も使えます。 |
...
### v0.5.8-beta.1 ← 最近のプレビュー版

- 画像 Prompt 逆生成、AI モデルサービス設定、プロジェクト Skill のコンパクトリストをプレビュー検証に追加
- CLI `--version` を npm package の `0.5.8-beta.1` と同期
