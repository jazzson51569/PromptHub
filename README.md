...
| 预览版  | [![Preview v0.5.8-beta.1](https://img.shields.io/badge/Preview-v0.5.8--beta.1-8B5CF6?style=for-the-badge&logo=github&logoColor=white)](https://github.com/legeling/PromptHub/releases/tag/v0.5.8-beta.1)                                                                                                                                                                                                                                                | 当前预览版：`v0.5.8-beta.1`。也可在应用内「设置 → 关于」打开「预览版通道」后自动检查并升级                                                                                                                                                                                                                                                                                                                                                                        |
...
- 图片 Prompt 反推、AI 模型服务配置和项目 Skill 列表体验进入预览验证
- CLI `--version` 与 npm package 版本同步到 `0.5.8-beta.1`
